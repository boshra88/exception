    ...
    @endif
          ...
          <div class="col-md-12">
            ...
            <div class="row mb-3">
              <div class="col-md-9">
                  ...
                  <a type="button" class="btn btn-primary data-placement="top" title="Edit"   data-toggle="modal" data-target="#modalContactForm">Add Slider</a>

                   <a type="button" class="btn btn-primary data-placement="top"   data-toggle="modal" data-target="#modalUpdateLogo">Edit Logo</a>
            ...
            <div class="row">
              ...
              <div class="view view-cascade gradient-card-header mdb-color lighten-3 mb-4">
                <h5 class="mb-0 font-weight-bold">Sliders</h5>
              </div>
              <!-- Card image -->
                  <!-- Tab panels -->
                  <div class="">
       ...
       @foreach($sliders as $slider)
          <tr>
            ...
            <td><p>{{ $slider->tittle}}</p></td>
          
            <td><p>{{ $slider->content}}</p></td>
             <td><p>{{ $slider->image}}</p></td>
            <td>
             
               <a class="teal-text"     data-toggle="modal" data-target="#modalUpdateForm"  
                 data-image="{{$slider->image}}"  data-tittle="{{$slider->tittle}}" 
                 data-id="{{ $slider->id}}" data-content="{{ $slider->content}}" >
               <i class="fas fa-pencil-alt"  ></i></a>
                


              <a class="red-text" data-toggle="modal" data-target="#modalConfirmDelete" data-delet="{{ $slider->id}}" ><i class="fas fa-times"></i></a>
            </td>
          </tr>
   @endforeach
  ...
  <div class="modal-dialog modal-sm modal-notify modal-danger" role="document">
    ...
    <div class="modal-content text-center">
      ...
      <div class="modal-footer flex-center">
        <form action="{{route('destroy_slider')}} " method="post">
                    {{ csrf_field() }}
                   {{ method_field('delete') }}
              
                    
                      
                        <input type="hidden" name="del_slide" id="del_slide" value="" />
  ...
  <div class="modal-dialog modal-lg modal-notify modal-info" role="document">
    <div class="modal-content">
        <div class="modal-header text-center">
         <h4 class="modal-title w-100 font-weight-bold white-text">Edit Slider </h4>
...
<div class="modal fade" id="modalContactForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
  ...
  <div class="modal-dialog modal-lg modal-notify modal-info" role="document">
    <div class="modal-content">
        <div class="modal-header text-center">
         <h4 class="modal-title w-100 font-weight-bold white-text">Add Slider </h4>
      ...
      <div class="modal-body ">
        <form method="POST" action=" {{route('add_slider')}} "   method="POST" enctype="multipart/form-data">
                                @csrf 
 ...
 <div class="modal fade" id="modalUpdateLogo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
  aria-hidden="true">
  <div class="modal-dialog modal-lg modal-notify modal-info" role="document">
    <div class="modal-content">
        <div class="modal-header text-center">
      ...
      <div class="modal-body ">
        <form method="POST" action=" {{route('update_logo')}} "   enctype="multipart/form-data">
                                  {{ csrf_field() }}
                                {{ method_field('PATCH') }}
  ...
  <div class="file-field">
    ...
    <div class="file-path-wrapper">
      <input class="file-path validate" id="logo2" type="text" placeholder="Upload image " >
    </div>
  </div>
 ...
 <script src="{{asset('js/vaildetar.js')}}"></script>
  ...
  modal.find('.modal-body #form1').val(tittle)
   ...
   modal.find('.modal-body #form2').val(content)
    modal.find('.modal-body #img2').val(image)
   
    modal.find('.modal-body #slide_id').val(id)
  ...
  var modal = $(this)
  modal.find('.modal-footer #del_slide').val(delet)
