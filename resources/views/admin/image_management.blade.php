          ...
          <div class="col-md-12">
            ...
            <div class="row">
              ...
              <div class="view view-cascade gradient-card-header mdb-color lighten-3 mb-4">
                <h5 class="mb-0 font-weight-bold">Home Categories</h5>
              </div>
              <!-- Card image -->
                  <!-- Tab panels -->
                  <div class="">
            ...
            <td>
              ...
              data-description="{{$product->description}}"data-image1="{{$product->image_1}}" 
               ...
               <i class="fas fa-pencil-alt"  ></i></a>
                 ...
                 <a class="blue-text" href="{{url('/admin/images/')}}/{{$product->id}}" ><i class="fas fa-plus"></i></a>
  ...
  <div class="modal-dialog modal-lg modal-notify modal-info" role="document">
    <div class="modal-content">
        <div class="modal-header text-center">
         <h4 class="modal-title w-100 font-weight-bold white-text">Edit Home Categories</h4>
...
<div class="modal fade" id="modalContactForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
  ...
  <div class="modal-dialog modal-lg modal-notify modal-info" role="document">
    <div class="modal-content">
        <div class="modal-header text-center">
         <h4 class="modal-title w-100 font-weight-bold white-text">Add Home Categories </h4>
      ...
      <div class="modal-body ">
        <form method="POST" action=" {{route('add')}} "   method="POST" enctype="multipart/form-data">
                                @csrf 
