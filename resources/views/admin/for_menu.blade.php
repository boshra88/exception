          ...
          <div class="col-md-12">
            ...
            <div class="row mb-3">
              <div class="col-md-9">
                  ...
                  <a type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalAddForm" data-image_id="{{$menu->id}}">Add Product</a>
            ...
            <div class="row">
              ...
              <div class="view view-cascade gradient-card-header mdb-color lighten-3 mb-4">
                <h5 class="mb-0 font-weight-bold">Menu Products</h5>
              </div>
              <!-- Card image -->
                  <!-- Tab panels -->
                  <div class="">
  ...
  <div class="modal-dialog modal-sm modal-notify modal-danger" role="document">
    ...
    <div class="modal-content text-center">
      ...
      <div class="modal-footer flex-center">
        <form action="{{route('destroy_for_menu')}} " method="post">
                    {{ csrf_field() }}
                   {{ method_field('delete') }}
  ...
  <div class="modal-dialog modal-lg modal-notify modal-info" role="document">
    <div class="modal-content">
        <div class="modal-header text-center">
         <h4 class="modal-title w-100 font-weight-bold white-text">Edit Menu Product </h4>
      ...
      <div class="modal-body ">
        <form method="POST" action=" {{route('update_for_menu')}} " id="update"  enctype="multipart/form-data">
                                  {{ csrf_field() }}
                                {{ method_field('PATCH') }}
...
<div class="modal fade" id="modalAddForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
  ...
  <div class="modal-dialog modal-lg modal-notify modal-info" role="document">
    <div class="modal-content">
        <div class="modal-header text-center">
         <h4 class="modal-title w-100 font-weight-bold white-text">Add Menu Product</h4>
      ...
      <div class="modal-body ">
        <form method="POST" action=" {{route('add_for_menu')}} " id="add"  method="POST" enctype="multipart/form-data">
                                @csrf 
