          ...
          <div class="col-md-12">
            ...
            <div class="row mb-3">
              <div class="col-md-9">
                ...
                <a type="button" class="btn btn-primary "  data-toggle="modal" data-target="#modalContactForm">Add Category</a>
            ...
            <div class="row">
              ...
              <div class="view view-cascade gradient-card-header mdb-color lighten-3 mb-4">
                <h5 class="mb-0 font-weight-bold">Menu Categories</h5>
              </div>
              <!-- Card image -->
                  <!-- Tab panels -->
                  <div class="">
            ...
            <td>
              ...
              data-description="{{$product->description}}"data-image1="{{$product->image_1}}" 
               ...
               <i class="fas fa-pencil-alt"  ></i></a>
                ...
                <a class="blue-text" href="{{url('/admin/menu/')}}/{{$product->id}}" ><i class="fas fa-plus"></i></a>
  ...
  <div class="modal-dialog modal-sm modal-notify modal-danger" role="document">
    ...
    <div class="modal-content text-center">
      ...
      <div class="modal-footer flex-center">
        <form action="{{route('destroy_menu')}} " method="post">
                    {{ csrf_field() }}
                   {{ method_field('delete') }}
...
<div class="modal fade" id="modalUpdateForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
  ...
  <div class="modal-dialog modal-lg modal-notify modal-info" role="document">
    <div class="modal-content">
        <div class="modal-header text-center">
         <h4 class="modal-title w-100 font-weight-bold white-text">Edit Menu Categories </h4>
      ...
      <div class="modal-body ">
        <form method="POST" action=" {{route('update_menu')}} "   enctype="multipart/form-data">
                                  {{ csrf_field() }}
                                {{ method_field('PATCH') }}
        ...
        <div class="md-form ">
          ...
          <label data-error="wrong" data-success="right" for="form34">Tittle</label>
        </div>
        ...
        <div class="md-form ">
          ...
          <label data-error="wrong" data-success="right" for="form32">Tittle 1</label>
        </div>
  ...
  <div class="file-field">
    ...
    <div class="file-path-wrapper">
      <input class="file-path validate" id="img" type="text" placeholder="Upload image ">
    </div>
  </div>
  ...
  <div class="file-field">
    ...
    <div class="file-path-wrapper">
      <input class="file-path validate" type="text" id="img1" placeholder="Upload image 1">
    </div>
  </div>
</div>
  ...
  <div class="file-field">
    ...
    <div class="file-path-wrapper">
      <input class="file-path validate" type="text"  id="img2"  placeholder="Upload image 2">
    </div>
  </div>
</div>
...
<div class="modal fade" id="modalContactForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
  ...
  <div class="modal-dialog modal-lg modal-notify modal-info" role="document">
    <div class="modal-content">
        <div class="modal-header text-center">
         <h4 class="modal-title w-100 font-weight-bold white-text">Add Menu Categories</h4>
      ...
      <div class="modal-body ">
        <form method="POST" action=" {{route('add_menu')}} "   method="POST" enctype="multipart/form-data">
                                @csrf 
  ...
  <div class="file-field">
    <div class="btn btn-primary btn-sm float-left">
      <span>Choose image</span>
      <input type="file"  id="image_1"  name="image_1"  accept="image/x-png,image/gif,image/jpeg"  required>
    </div>
    <div class="file-path-wrapper">
      <input class="file-path validate" type="text" placeholder="Upload image 1">
    </div>
  </div>
</div>
  ...
  <div class="file-field">
    <div class="btn btn-primary btn-sm float-left">
      <span>Choose image</span>
      <input type="file"  id="image_2" name="image_2"  accept="image/x-png,image/gif,image/jpeg" required>
    </div>
    <div class="file-path-wrapper">
      <input class="file-path validate" type="text" placeholder="Upload image 2">
    </div>
  </div>
</div>
