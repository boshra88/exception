               ...
               <div class="col-md-4 mt-5">
                ...
                <div class="card card-cascade narrower card-ecommerce">
                  ...
                  <div class="card-body card-body-cascade text-center no-padding">
                    ...
                    <h4 class="card-title">
                      <strong>
                        <a href="{{url('show_img')}}/{{$product->id}}">{{$product->tittle}}</a>
                      </strong>
                      <hr>
                    ...
                    <!--Card footer-->
                       ...
                       <p class="text-right mb-0 font-small font-weight-bold "><a  href="{{url('show_img')}}/{{$product->id}}">read more <i class="fas fa-angle-right"></i></a></p>
