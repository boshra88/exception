...
<body class="postpage-v3">
    ...
    <div class="container mt-5 pt-3">
        ...
        <div class="row pt-4">
            ...
            <!-- Content -->
            <div class="col-lg-12">
                 @if(( $products->count() == 0) && ($in_menus->count() == 0) && ($in_images->count() == 0)) 
              ...
              <!--Grid column-->
               <div class="col-md-4 mt-5">
                ...
                <div class="card card-cascade narrower card-ecommerce">
                  ...
                  <!--Card image-->
                  <div class="view view-cascade overlay zoom">
                    <img src="{{asset('img/products')}}/{{$in_menu->image}}" class="card-img-top fit-img"
                      alt="">
                    <a>
                      <div class="mask rgba-white-slight"></div>
                    </a>
                  ...
                  <div class="card-body card-body-cascade text-center no-padding">
                    ...
                    <h4 class="card-title">
                      <strong>
                        <a href="{{url('show_menu')}}/{{$in_menu->id}}">{{$in_menu->tittle}}</a>
                      </strong>
                      <hr>
                    ...
                    <!--Description-->
                    <p class="card-text"> {{$in_menu->description}}
                    </p>

                    <!--Card footer-->
                  
                       <p class="text-right mb-0 font-small font-weight-bold "><a href="{{url('show_menu')}}/{{$in_menu->id}}">read more <i class="fas fa-angle-right pb-0 mb-0"></i></a></p>
              ...
              <!--Grid column-->
               <div class="col-md-4 mt-5">
                ...
                <div class="card card-cascade narrower card-ecommerce">
                  ...
                  <!--Card image-->
                  <div class="view view-cascade overlay zoom">
                    <img src="{{asset('img/products')}}/{{$in_image->image}}" class="card-img-top fit-img"
                      alt="">
                    <a>
                      <div class="mask rgba-white-slight"></div>
                    </a>
                  ...
                  <div class="card-body card-body-cascade text-center no-padding">
                    ...
                    <h4 class="card-title">
                      <strong>
                        <a href="{{url('show_img')}}/{{$in_image->id}}">{{ $in_image->tittle}}</a>
                      </strong>
                      <hr>
                    ...
                    <!--Description-->
                    <p class="card-text"> {{$in_image->description}}
                    </p>

                    <!--Card footer-->
                  
                       <p class="text-right mb-0 font-small font-weight-bold "><a href="{{url('show_img')}}/{{$in_image->id}}">read more <i class="fas fa-angle-right pb-0 mb-0"></i></a></p>
